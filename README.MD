...
Agora navegue até a pasta criada, abra no Visual Studio Code e por último abra o arquivo `index.js`. Lembre-se de executar o comando `yarn` ou `npm install` no seu terminal para instalar todas as dependências.
...
Aqui teremos uma breve descrição do que cada middleware deve fazer e na seção [Especificação dos testes](#testes) você verá com mais detalhes o que precisa ser feito para satisfazer cada teste.
...
Desafio feito com 💜 por Rocketseat 👋 Participe da nossa [comunidade aberta!](https://discord.gg/pUU3CG4Z)

Realizado por **[Kelvyn Costa](https://github.com/kelvyncosta)**